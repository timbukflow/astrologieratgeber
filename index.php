...
<body>
    ...
    <section class="maincontent">
        ...
        <div class="astrocirclecontainer">
            ...
            <img class="astrocircle acfast" src="img/astro-circle-fast.svg" alt="">
            <img class="astrocircle acmiddle" src="img/astro-circle-middle.svg" alt="">
            <img class="astrocircle acslow" src="img/astro-circle-slow.svg" alt="">
        </div>
        <p>
